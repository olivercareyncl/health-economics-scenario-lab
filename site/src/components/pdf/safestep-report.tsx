...
function buildOverview(
  ...
  return `This risk-targeted falls prevention scenario suggests that the programme could avoid ${formatNumber(
...
function buildPlainEnglishResults(
  ...
  return [
    ...
    {
      body: `Taken together, the current signal remains ${decisionStatus.toLowerCase()}. This should be read as an indicative scenario result rather than a definitive conclusion, because the case remains sensitive to effect size, participation, and delivery cost.`,
    },
  ];
}
...
export function buildSafeStepReportData({
  ...
  return {
    ...
    executiveSummary: {
      ...
      mainDependency: `The result is mainly driven by ${mainDriver}, delivery cost, and the realism of programme participation.`,
