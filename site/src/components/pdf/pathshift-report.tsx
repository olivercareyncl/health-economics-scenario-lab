...
import type { PathShiftReportData } from "@/lib/pathshift/report";

type PathShiftReportDocumentProps = {
  data: PathShiftReportData;
};
  ...
  return (
    <View style={styles.header} fixed>
      ...
      <View style={styles.headerRight}>
        <Text style={styles.moduleLabel}>PathShift</Text>
...
function Footer() {
  return (
    <View style={styles.footer} fixed>
      <Text style={styles.footerText}>Health Economics Scenario Lab · PathShift</Text>
      <Text
...
export function PathShiftReportDocument({
  data,
}: PathShiftReportDocumentProps) {
  return (
    <Document>
