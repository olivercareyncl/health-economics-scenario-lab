...
import type { WaitWiseReportData } from "@/lib/waitwise/report";

type WaitWiseReportDocumentProps = {
  data: WaitWiseReportData;
};
  ...
  return (
    <View style={styles.header} fixed>
      ...
      <View style={styles.headerRight}>
        <Text style={styles.moduleLabel}>WaitWise</Text>
...
function Footer() {
  return (
    <View style={styles.footer} fixed>
      <Text style={styles.footerText}>Health Economics Scenario Lab · WaitWise</Text>
      <Text
...
export function WaitWiseReportDocument({
  data,
}: WaitWiseReportDocumentProps) {
  return (
    <Document>
