...
import type { FrailtyForwardReportData } from "@/lib/frailtyforward/report";

type FrailtyForwardReportDocumentProps = {
  data: FrailtyForwardReportData;
};
  ...
  return (
    <View style={styles.header} fixed>
      ...
      <View style={styles.headerRight}>
        <Text style={styles.moduleLabel}>FrailtyForward</Text>
  ...
  return (
    <View style={styles.footer} fixed>
      <Text style={styles.footerText}>
        Health Economics Scenario Lab · FrailtyForward
      </Text>
      <Text
...
export function FrailtyForwardReportDocument({
  data,
}: FrailtyForwardReportDocumentProps) {
  return (
    <Document>
